...
package com.kingscripts.autoskyblock;
...
public class AutoSkyblockInstallerFrame extends JFrame implements ActionListener, MouseListener {
    ...
    public AutoSkyblockInstallerFrame() {
        try {
            this.setName("AutoSkyblockInstallerFrame");
            this.setTitle("AutoSkyblock Installer");
    ...
    public static void main(String[] args) {
        try {
            ...
            AutoSkyblockInstallerFrame frame = new AutoSkyblockInstallerFrame();
    ...
    private JLabel getPictureLabel() {
        if (this.logo == null) {
            try {
                this.h = this.w / 2;
                this.margin = 5;
                BufferedImage myPicture = ImageIO.read((InputStream)Objects.requireNonNull(this.getClass().getClassLoader().getResourceAsStream("assets/logo.png"), "Logo not found."));
                Image scaled = myPicture.getScaledInstance(this.w / 2 - this.margin * 2, this.h - this.margin, 4);
    ...
    private JLabel getVersionInfo() {
        if (this.versionInfo == null) {
            try {
                ...
                this.versionInfo.setText("AutoSkyblockMod-" + this.getVersionFromMcmodInfo() + " by King Scripts");
                this.y += this.h;
            } catch (Throwable var2) {
                showErrorPopup(var2);
            }
    ...
    private JTextArea getTextArea() {
        if (this.descriptionText == null) {
            try {
                ...
                this.descriptionText.setText("This installer will copy Auto Skyblock Mod into your Forge mods folder for you, and replace any old versions that already exist. Close this if you prefer to do this yourself!");
    ...
    private JButton getButtonFolder() {
        if (this.buttonChooseFolder == null) {
            ...
            try {
                BufferedImage myPicture = ImageIO.read((InputStream)Objects.requireNonNull(this.getClass().getClassLoader().getResourceAsStream("assets/dungeonrooms/gui/folder.png"), "Folder icon not found."));
    ...
    private void tryInstall(File modsFolder) {
        ...
        if (thisFile != null) {
            ...
            File newFile = new File(modsFolder, "Auto_Skyblock-" + this.getVersionFromMcmodInfo() + ".jar");
            ...
            boolean failed;
//            if (modsFolder.isDirectory()) {
//                failed = this.findDungeonRoomsAndDelete(modsFolder.listFiles());
//                if (failed) {
...
//                    failed = this.findDungeonRoomsAndDelete(modsFolder.getParentFile().listFiles());
//                    if (failed) {
//                        deletingFailure = true;
//                    }
//                }
...
//                    boolean failed = this.findDungeonRoomsAndDelete(subFolder.listFiles());
//                    if (failed) {
//                        deletingFailure = true;
//                    }
//                }
//            }
            ...
            this.showMessage("Auto Skyblock Mod has been successfully installed into your mods folder.");
            this.dispose();
            System.exit(0);
        }
                        ...
                        if (mcModInfo != null) {
                            ...
                            if (modID.equals("autoskyblock")) {
                                ...
                                try {
                                    ...
                                    this.showErrorMessage("Was not able to delete the other Auto Skyblock Mod files found in your mods folder!" + System.lineSeparator() + "Please make sure that Minecraft is currently closed and try again, or feel" + System.lineSeparator() + "free to open your mods folder and delete those files manually.");
                                    return true;
                                }
                            }
                        }
    ...
    public OperatingSystem getOperatingSystem() {
        ...
        if (osName.contains("win")) {
            return AutoSkyblockInstallerFrame.OperatingSystem.WINDOWS;
        } else if (osName.contains("mac")) {
            return AutoSkyblockInstallerFrame.OperatingSystem.MACOS;
        } else if (!osName.contains("solaris") && !osName.contains("sunos")) {
            return !osName.contains("linux") && !osName.contains("unix") ? AutoSkyblockInstallerFrame.OperatingSystem.UNKNOWN : AutoSkyblockInstallerFrame.OperatingSystem.LINUX;
        } else {
            return AutoSkyblockInstallerFrame.OperatingSystem.SOLARIS;
        }
    }
    ...
    public void showMessage(String message) {
        JOptionPane.showMessageDialog((Component)null, message, "Auto Skyblock Mod", 1);
    }

    public void showErrorMessage(String message) {
        JOptionPane.showMessageDialog((Component)null, message, "Auto Skyblock Mod - Error", 0);
    }
    ...
    private File getThisFile() {
        try {
            return new File(AutoSkyblockInstallerFrame.class.getProtectionDomain().getCodeSource().getLocation().toURI());
